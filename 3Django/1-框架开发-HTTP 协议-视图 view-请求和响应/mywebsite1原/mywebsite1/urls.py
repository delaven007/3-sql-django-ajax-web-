...
urlpatterns = [
    ...
    url(r'^birthday',views.birthday_view),
    ...
    url(r'^(\d+)/(\w{3})/(\d+)$',views.jishu_view),
    #url(r'date/(?P<y>\d{4})/(?P<m>\d{1,2})/(?P<d>\d{1,2})$',views.date_view),
    url(r'date/(\d{4})/(\d{1,2})/(\d{1,2})$',views.date_view),
    #url(r'date/(?P<m>\d{1,2})/(?P<d>\d{1,2})/(?P<y>\d{4})$',views.date_view),
